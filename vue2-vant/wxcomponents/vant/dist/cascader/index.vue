<template>
<uni-shadow-root class="vant-dist-cascader-index"><view v-if="showHeader" class="van-cascader__header">
...
global['__wxRoute'] = 'vant/dist/cascader/index'
...
export default global['__wxComponents']['vant/dist/cascader/index']
</script>
